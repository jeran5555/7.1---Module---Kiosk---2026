                ...
                <div class="cart-items-list">
                    <div class="cart-item-row" onclick="document.getElementById('opt-zonder-saus').click()">
                        <div style="display: flex; align-items: center; gap: 15px;">
                            <input type="checkbox" id="opt-zonder-saus" class="customize-checkbox" value="Zonder saus" style="width: 20px; height: 20px;" onclick="event.stopPropagation()">
                    ...
                    <div class="cart-item-row" onclick="document.getElementById('opt-zonder-sla').click()">
                        <div style="display: flex; align-items: center; gap: 15px;">
                            <input type="checkbox" id="opt-zonder-sla" class="customize-checkbox" value="Zonder sla" style="width: 20px; height: 20px;" onclick="event.stopPropagation()">
                    ...
                    <div class="cart-item-row" onclick="document.getElementById('opt-zonder-tomaat').click()">
                        <div style="display: flex; align-items: center; gap: 15px;">
                            <input type="checkbox" id="opt-zonder-tomaat" class="customize-checkbox" value="Zonder tomaat" style="width: 20px; height: 20px;" onclick="event.stopPropagation()">
                    ...
                    <div class="cart-item-row" onclick="document.getElementById('opt-zonder-ui').click()">
                        <div style="display: flex; align-items: center; gap: 15px;">
                            <input type="checkbox" id="opt-zonder-ui" class="customize-checkbox" value="Zonder ui" style="width: 20px; height: 20px;" onclick="event.stopPropagation()">
